...
def num_eights(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    return 0 if n<8 else 1+num_eights(n//10) if n%10==8 else num_eights(n//10)
...
def digit_distance(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    return 0 if n<10 else abs(n//10%10-n%10)+digit_distance(n//10)
...
def interleaved_sum(n, odd_func, even_func):
    ...
    def inner(k):
        if k>n : return 0
        elif k==n: return odd_func(n)
        else : return odd_func(k)+even_func(k+1)+inner(k+2)
    return inner(1)
...
def count_dollars(total):
    ...
    """
    "*** YOUR CODE HERE ***"
    # same code in class but with a nest function
...
def count_dollars_upward(total):
    ...
    def constrained_count(total, largest_bill):
        ...
        if largest_bill == None:
            return 0
        without_dollar_bill = constrained_count(total, next_larger_dollar(largest_bill))
        with_dollar_bill = constrained_count(total - largest_bill, largest_bill)
        return without_dollar_bill + with_dollar_bill
