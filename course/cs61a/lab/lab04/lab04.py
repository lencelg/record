...
def distance(city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    lan=abs(get_lat(city_a)-get_lat(city_b))**2
    lon=abs(get_lon(city_a)-get_lon(city_b))**2
    return sqrt(lan+lon)
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    destination=make_city('des',lat,lon)
    distance_a=distance(city_a,destination)
    distance_b=distance(city_b,destination)
