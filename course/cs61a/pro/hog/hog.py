...
def play(strategy0, strategy1, update,
    ...
    while (score0<goal and  score1<goal):
        if (who==0):
            ...
            score0=update(numrolls,score0,score1,dice)
            who=1
        else:
            numrolls=strategy1(score1,score0)
            score1=update(numrolls,score1,score0,dice)
            who=0
    # END PROBLEM 5
...
def max_scoring_num_rolls(dice=six_sided, times_called=1000):
    ...
    res=0
    for i in range(1,11):
        curscore=make_averaged(roll_dice,times_called)(i,dice)
        if curscore>score:
            score=curscore
            res=i
    return res 
