 ...
 * i am a nice person and i do not leave a puzzle to the next one
 */
...
string onlyConnectize(string phrase) {
    ...
    cout<<"now the phrase is  "<<phrase<<endl;
...
STUDENT_TEST("description of the test") {
    ...
    EXPECT_EQUAL(onlyConnectize("man ba out"), "MNBT");
    EXPECT_EQUAL(onlyConnectize("not a good new"), "NTGDNW");
    EXPECT_EQUAL(onlyConnectize("no more warning please"), "NMRWRNNGPLS");
}
